# Run summary — `webarena_gmail_pair_algorithmic_60_trial0_2026-06-19T07-26-07Z_resume_from_59`

- T = 60
- alpha = 0.05
- per-arm null m_0 = 0.5
- global log-e = -1.733 (e = 0.177); global null rejected = **False**
...
|---|---|---|---|---|---|---|---|---|---|
| algorithmic | ★ | 60 | 30 | 0.500 | 0.000 | -1.733 | 0.323 | 0.708 | False |

Empirical best arm a* = **algorithmic** (μ̂ = 0.500).
