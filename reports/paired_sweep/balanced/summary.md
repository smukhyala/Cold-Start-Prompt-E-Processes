# Run summary — `webarena_gmail_pair_balanced_60_trial0_2026-06-18T21-31-55Z_resume_from_44`

- T = 60
- alpha = 0.05
- per-arm null m_0 = 0.5
- global log-e = -1.434 (e = 0.238); global null rejected = **False**
...
|---|---|---|---|---|---|---|---|---|---|
| balanced | ★ | 60 | 34 | 0.567 | 0.000 | -1.434 | 0.385 | 0.769 | False |

Empirical best arm a* = **balanced** (μ̂ = 0.567).
