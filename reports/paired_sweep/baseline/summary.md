# Run summary — `webarena_gmail_pair_baseline_60_trial0_2026-06-16T18-47-31Z_resume_from_42`

- T = 60
- alpha = 0.05
- per-arm null m_0 = 0.5
- global log-e = -0.582 (e = 0.559); global null rejected = **False**
- τ_α (first global rejection) = 22

## Per-arm final state

| arm | a* | pulls | successes | μ̂_a | Δ_a | log_e | CS low | CS high | rejected |
|---|---|---|---|---|---|---|---|---|---|
| baseline | ★ | 60 | 35 | 0.583 | 0.000 | -0.582 | 0.400 | 0.800 | False |

Empirical best arm a* = **baseline** (μ̂ = 0.583).
