# Run summary — `webarena_gmail_pair_cautious_60_trial0_2026-06-18T17-26-29Z_resume_from_48`

- T = 60
- alpha = 0.05
- per-arm null m_0 = 0.5
- global log-e = -1.626 (e = 0.197); global null rejected = **False**
- τ_α (first global rejection) = 25

## Per-arm final state

| arm | a* | pulls | successes | μ̂_a | Δ_a | log_e | CS low | CS high | rejected |
|---|---|---|---|---|---|---|---|---|---|
| cautious | ★ | 60 | 33 | 0.550 | 0.000 | -1.626 | 0.369 | 0.769 | False |

Empirical best arm a* = **cautious** (μ̂ = 0.550).
