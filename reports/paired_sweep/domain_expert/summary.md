# Run summary — `webarena_gmail_pair_domain_expert_60_trial0_2026-06-19T17-14-55Z_resume_from_58`

- T = 60
- alpha = 0.05
- per-arm null m_0 = 0.5
- global log-e = -0.141 (e = 0.868); global null rejected = **False**
- τ_α (first global rejection) = 14

## Per-arm final state

| arm | a* | pulls | successes | μ̂_a | Δ_a | log_e | CS low | CS high | rejected |
|---|---|---|---|---|---|---|---|---|---|
| domain_expert | ★ | 60 | 36 | 0.600 | 0.000 | -0.141 | 0.415 | 0.800 | False |

Empirical best arm a* = **domain_expert** (μ̂ = 0.600).
