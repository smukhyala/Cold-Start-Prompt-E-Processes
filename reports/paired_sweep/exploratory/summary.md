# Run summary — `webarena_gmail_pair_exploratory_60_trial0_2026-06-19T05-17-59Z_resume_from_54`

- T = 60
- alpha = 0.05
- per-arm null m_0 = 0.5
- global log-e = 1.385 (e = 3.99); global null rejected = **False**
- τ_α (first global rejection) = 12

## Per-arm final state

| arm | a* | pulls | successes | μ̂_a | Δ_a | log_e | CS low | CS high | rejected |
|---|---|---|---|---|---|---|---|---|---|
| exploratory | ★ | 60 | 39 | 0.650 | 0.000 | 1.385 | 0.462 | 0.815 | False |

Empirical best arm a* = **exploratory** (μ̂ = 0.650).
