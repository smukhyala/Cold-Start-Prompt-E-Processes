# Run summary — `webarena_gmail_pair_explorer_60_trial0_2026-06-18T19-02-05Z_resume_from_44`

- T = 60
- alpha = 0.05
- per-arm null m_0 = 0.5
- global log-e = -1.117 (e = 0.327); global null rejected = **False**
...
|---|---|---|---|---|---|---|---|---|---|
| explorer | ★ | 60 | 33 | 0.550 | 0.000 | -1.117 | 0.369 | 0.754 | False |

Empirical best arm a* = **explorer** (μ̂ = 0.550).
