# Run summary — `webarena_gmail_pair_junior_reactive_60_trial0_2026-06-19T15-56-01Z_resume_from_41`

- T = 60
- alpha = 0.05
- per-arm null m_0 = 0.5
- global log-e = 4.334 (e = 76.2); global null rejected = **True**
...
|---|---|---|---|---|---|---|---|---|---|
| junior_reactive | ★ | 60 | 42 | 0.700 | 0.000 | 4.334 | 0.523 | 0.892 | True |

Empirical best arm a* = **junior_reactive** (μ̂ = 0.700).
