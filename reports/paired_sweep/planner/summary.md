# Run summary — `webarena_gmail_pair_planner_60_trial0_2026-06-16T20-03-52Z_resume_from_59`

- T = 60
- alpha = 0.05
- per-arm null m_0 = 0.5
- global log-e = -1.311 (e = 0.269); global null rejected = **False**
...
|---|---|---|---|---|---|---|---|---|---|
| planner | ★ | 60 | 27 | 0.450 | 0.000 | -1.311 | 0.292 | 0.646 | False |

Empirical best arm a* = **planner** (μ̂ = 0.450).
