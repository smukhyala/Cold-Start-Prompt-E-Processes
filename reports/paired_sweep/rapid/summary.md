# Run summary — `webarena_gmail_pair_rapid_60_trial0_2026-06-19T00-52-23Z_resume_from_58`

- T = 60
- alpha = 0.05
- per-arm null m_0 = 0.5
- global log-e = -0.646 (e = 0.524); global null rejected = **False**
...
|---|---|---|---|---|---|---|---|---|---|
| rapid | ★ | 60 | 35 | 0.583 | 0.000 | -0.646 | 0.400 | 0.754 | False |

Empirical best arm a* = **rapid** (μ̂ = 0.583).
