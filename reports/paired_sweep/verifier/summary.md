# Run summary — `webarena_gmail_pair_verifier_60_trial0_2026-06-19T02-40-25Z_resume_from_60`

- T = 60
- alpha = 0.05
- per-arm null m_0 = 0.5
- global log-e = -1.327 (e = 0.265); global null rejected = **False**
...
|---|---|---|---|---|---|---|---|---|---|
| verifier | ★ | 60 | 34 | 0.567 | 0.000 | -1.327 | 0.385 | 0.785 | False |

Empirical best arm a* = **verifier** (μ̂ = 0.567).
