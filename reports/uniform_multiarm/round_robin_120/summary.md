# Run summary — `webarena_gmail_uniform_multiarm_120_trial0_2026-06-20T19-46-07Z_resume_from_118`

- T = 120
- alpha = 0.05
- per-arm null m_0 = 0.5
- global log-e = 0.832 (e = 2.3); global null rejected = **False**
...
|---|---|---|---|---|---|---|---|---|---|
| algorithmic |  | 10 | 5 | 0.500 | 0.400 | -1.460 | 0.062 | 0.908 | False |
| balanced |  | 10 | 6 | 0.600 | 0.300 | -1.115 | 0.138 | 0.969 | False |
| baseline | ★ | 10 | 9 | 0.900 | 0.000 | 2.737 | 0.446 | 0.985 | False |
| cautious |  | 10 | 4 | 0.400 | 0.500 | -0.693 | 0.015 | 0.831 | False |
| domain_expert |  | 10 | 6 | 0.600 | 0.300 | -0.848 | 0.154 | 0.985 | False |
| exploratory |  | 10 | 8 | 0.800 | 0.100 | 1.452 | 0.323 | 0.985 | False |
| explorer |  | 10 | 6 | 0.600 | 0.300 | -0.703 | 0.169 | 0.985 | False |
| junior_reactive |  | 10 | 5 | 0.500 | 0.400 | -1.175 | 0.062 | 0.908 | False |
| overthinker |  | 10 | 6 | 0.600 | 0.300 | -1.506 | 0.123 | 0.969 | False |
| planner |  | 10 | 8 | 0.800 | 0.100 | 1.341 | 0.323 | 0.985 | False |
| rapid |  | 10 | 7 | 0.700 | 0.200 | 0.149 | 0.262 | 0.985 | False |
| verifier |  | 10 | 4 | 0.400 | 0.500 | -0.979 | 0.046 | 0.846 | False |

Empirical best arm a* = **baseline** (μ̂ = 0.900).
