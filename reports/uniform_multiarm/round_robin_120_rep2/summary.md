# Run summary — `webarena_gmail_uniform_multiarm_120_rep2_trial0_2026-06-21T03-16-13Z_resume_from_117`

- T = 120
- alpha = 0.05
- per-arm null m_0 = 0.5
- global log-e = -0.569 (e = 0.566); global null rejected = **False**
...
| baseline | ★ | 10 | 7 | 0.700 | 0.000 | 0.186 | 0.246 | 0.985 | False |
| cautious |  | 10 | 3 | 0.300 | 0.400 | -0.693 | 0.015 | 0.738 | False |
| domain_expert |  | 10 | 6 | 0.600 | 0.100 | -0.848 | 0.154 | 0.985 | False |
| exploratory |  | 10 | 6 | 0.600 | 0.100 | -0.848 | 0.154 | 0.985 | False |
| explorer |  | 10 | 6 | 0.600 | 0.100 | -0.703 | 0.169 | 0.985 | False |
| junior_reactive |  | 10 | 4 | 0.400 | 0.300 | -0.693 | 0.015 | 0.831 | False |
| overthinker |  | 10 | 6 | 0.600 | 0.100 | -1.506 | 0.123 | 0.969 | False |
| planner |  | 10 | 6 | 0.600 | 0.100 | -1.095 | 0.138 | 0.969 | False |
| rapid |  | 10 | 6 | 0.600 | 0.100 | -0.076 | 0.154 | 0.969 | False |
| verifier |  | 10 | 2 | 0.200 | 0.500 | 0.000 | 0.015 | 0.677 | False |
