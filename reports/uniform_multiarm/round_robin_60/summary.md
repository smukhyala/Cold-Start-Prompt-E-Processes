# Run summary — `webarena_gmail_uniform_multiarm_60_trial0_2026-06-19T19-27-58Z_resume_from_49`

- T = 60
- alpha = 0.05
- per-arm null m_0 = 0.5
- global log-e = 0.475 (e = 1.61); global null rejected = **False**
...
|---|---|---|---|---|---|---|---|---|---|
| algorithmic |  | 5 | 4 | 0.800 | 0.200 | 0.523 | 0.138 | 0.985 | False |
| balanced |  | 5 | 4 | 0.800 | 0.200 | 0.523 | 0.138 | 0.985 | False |
| baseline | ★ | 5 | 5 | 1.000 | 0.000 | 1.622 | 0.262 | 0.985 | False |
| cautious |  | 5 | 2 | 0.400 | 0.600 | -0.693 | 0.015 | 0.985 | False |
| domain_expert |  | 5 | 3 | 0.600 | 0.400 | -0.575 | 0.015 | 0.985 | False |
| exploratory |  | 5 | 4 | 0.800 | 0.200 | 0.523 | 0.138 | 0.985 | False |
| explorer |  | 5 | 3 | 0.600 | 0.400 | -0.575 | 0.015 | 0.985 | False |
| junior_reactive |  | 5 | 2 | 0.400 | 0.600 | -0.693 | 0.015 | 0.985 | False |
| overthinker |  | 5 | 3 | 0.600 | 0.400 | -1.082 | 0.015 | 0.985 | False |
| planner |  | 5 | 5 | 1.000 | 0.000 | 1.622 | 0.262 | 0.985 | False |
| rapid |  | 5 | 3 | 0.600 | 0.400 | -0.439 | 0.015 | 0.985 | False |
| verifier |  | 5 | 1 | 0.200 | 0.800 | 0.000 | 0.015 | 0.908 | False |

Empirical best arm a* = **baseline** (μ̂ = 1.000).
